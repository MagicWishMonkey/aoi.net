...
namespace AOI.Data {
    ...
    public class QueryParameter {
        ...
        //public QueryParameter(string name, DbType type) : this(name, null, ParameterDirection.Input) { }
        //public QueryParameter(string name, ParameterDirection direction) : this(name, null, direction) { }
        //public QueryParameter(string name, object value) : this(name, value, ParameterDirection.Input) { }
        //public QueryParameter(string name, object value, DbType type, ParameterDirection direction) {
        //    Contract.Requires(!String.IsNullOrEmpty(name));
        //    this.Name = name;
        //    this.Value = value;
        //    this.Direction = direction;
