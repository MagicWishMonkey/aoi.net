...
namespace AOI.Util.IO {
    public sealed class Directory : IComparable, IFileSystemEntry {
        ...
        /// </summary>
        public Directory FindPrecedingDirectory(string name) {
            Directory current = this;
            while (current != null && !current.IsRoot) {
                if (current.ContainsDirectory(name))
        ...
        /// <summary>
        /// Walk backwards through the directory tree until
        /// the specified file name is located.
        /// </summary>
        public File FindPrecedingFile(string name) {
            Directory current = this;
            while (current != null && !current.IsRoot) {
